	...
	public class LoginPageViewMediator extends Mediator
	{
		...
		public function onInvokeEvent(invocation:InvokeEvent):void 
		{
			...
			if(Capabilities.isDebugger)
			{
				...
				url="bigbluebutton://142.204.133.100/bigbluebutton/api/join?fullName=User+5688227&meetingID=random-2679065&password=mp&checksum=a4db2500b5815642fb0054aa5a3a77f7d97de190";
